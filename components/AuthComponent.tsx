      ...
      <div className="p-6 max-w-md mx-auto bg-white rounded-lg shadow-md">
        ...
        <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded">
          <p className="text-green-800">
            <strong>Signed in as:</strong> {session.user?.name}
          </p>
          <p className="text-green-600 text-sm">Email: {session.user?.email}</p>
          <p className="text-green-600 text-sm">User ID: {session.user?.id}</p>
        </div>
    ...
    <div className="p-6 max-w-md mx-auto bg-white rounded-lg shadow-md">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          disabled={isLoading !== ''}
          className="w-full bg-gray-800 hover:bg-gray-900 disabled:bg-gray-400 text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center space-x-2"
        >
      ...
      <div className="mt-6 p-3 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-blue-800 text-sm text-center">
          <strong>Sign in with your preferred social account</strong>
        </p>
        <p className="text-blue-600 text-xs text-center mt-1">
          No account creation required - just use your existing social login
        </p>
      </div>
    </div>
  )
